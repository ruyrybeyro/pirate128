...
;
; Routine for the 128K+2/2A/3 to load bank 3 ROM
; and map RAM on top of ROM/address $0000
;
...
; $7ffd - Bits 0-2: RAM page (0-7) to map into memory at 0xc000.
	...
	OUT     (C),A	       ; change bank 0 for bank 3 at $C000
	RET
...
SPECIAL_MODE:
	...
	JP      $FEAD	; JUMP to the beginning of the "new" "ROM"
